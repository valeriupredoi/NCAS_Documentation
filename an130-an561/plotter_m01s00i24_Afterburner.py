...
for yr in years:
    ...
    fcy1a = spmean(fcy1)
    fnnc = '/group_workspaces/jasmin/ncas_cms/valeriu/an130_an561/m01s00i024_apy/' + str(yr) + '.nc'
...
# surface temperature m01s00i024
c1 = iris.load_cube('an130_apy_m01s00i024_global.nc')
#######################################################
# plotting
import numpy as np
fig = plt.figure()
plt.suptitle('m01s00i024 Surface Temperature an130-an561\nwith Afterburner functions')
...
plt.grid()
plt.ylabel('dT (an130 - an561) [K]')
plt.xlabel('Time [years]')
plt.xlim(1978,1989)
plt.savefig('./plots/an130-an561_TS_m01s00i024_wAfterbFuncs.png')
plt.show()
plt.close()
